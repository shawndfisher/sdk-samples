...
Copyright (c) 2017-2019 Cradlepoint, Inc. <www.cradlepoint.com>.  All rights reserved.
...
class CSClient(object):
    ...
    END_OF_HEADER = b"\r\n\r\n"
    STATUS_HEADER_RE = re.compile(r"status: \w*")
    CONTENT_LENGTH_HEADER_RE = re.compile(r"content-length: \w*")
    ...
    def delete(self, base, query=""):
        """
        Constructs and sends a delete request to remove specified data from the device router tree.

        The behavior of this method is contextual:
            - If the app is installed on(and executed from) a device, it directly removes the specified data to
              the router tree.
